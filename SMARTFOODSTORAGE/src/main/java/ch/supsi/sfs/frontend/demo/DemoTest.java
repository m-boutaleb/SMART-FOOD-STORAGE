package ch.supsi.sfs.frontend.demo;
...
public class DemoTest {
    ...
    public static final int LATENCY=600;
    ...
    /**
     * Metodo che controlla se è stato schiacciato il button d'emergenza
     * @param emergencyStop istanza del bottone
     */
    ...
    /**
     * Metodo che imposta il logger e inizializza il groviePiSimulator
     * @return GrovePiSimulator inizializzato
     */
